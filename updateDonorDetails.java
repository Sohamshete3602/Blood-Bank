...
public class updateDonorDetails extends JFrame implements ActionListener
{
	...
	public updateDonorDetails()
	{
		...
		t1=new JTextField();
		t1.setBounds(200,100,300,40);
		
		l2=new JLabel("Full Name");
		l2.setBounds(100,150,100,50);
		t2=new JTextField();
		t2.setBounds(200,150,300,40);
		
		l3=new JLabel("Father Name");
		l3.setBounds(100,200,100,50);
		t3=new JTextField();
		t3.setBounds(200,200,300,40);
		
		l4=new JLabel("Date of Birth");
		l4.setBounds(100,250,100,50);
		t4=new JTextField();
		t4.setBounds(200,250,300,40);
		
		l5=new JLabel("Mobile number");
		l5.setBounds(100,300,100,50);
		t5=new JTextField();
		t5.setBounds(200,300,300,40);
		
		l6=new JLabel("gender");
		l6.setBounds(100,350,100,50);
		c1=new JComboBox(s1);
		c1.setBounds(200,350,300,40);
		
		l7=new JLabel("Email ID");
		l7.setBounds(600,100,100,50);
		t7=new JTextField();
		t7.setBounds(700,100,300,40);
		
		l8=new JLabel("Blood Group");
		l8.setBounds(600,150,100,50);
		c2= new JComboBox(s2);
		c2.setBounds(700,150,300,40);
		...
		l10.setBounds(600,250,100,50);
		ta1=new JTextArea();
		ta1.setBounds(700,250,300,150);
